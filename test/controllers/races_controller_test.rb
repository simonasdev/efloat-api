...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { end_time: @race.end_time, start_time: @race.start_time, title: @race.title } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { end_time: @race.end_time, start_time: @race.start_time, title: @race.title } }
